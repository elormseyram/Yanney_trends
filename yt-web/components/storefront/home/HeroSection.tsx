...
export function HeroSection() {
  const wa = buildWhatsAppPrefill(
    "Hello Yanney Trends — I'd love to shop your new collection. Can you help me pick a size?",
    SHOP_WHATSAPP,
  );
